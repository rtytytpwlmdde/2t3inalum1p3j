...
function __construct(){
	...
	function tambahLowker(){
		...
		redirect('admin/lowker/riwayatpekerjaan');
	}
	...
	function updateLowongan($id_lowongan){
		$data['main_view'] = 'admin/v_edit_lowker';
