...
class paket_kuisioner extends CI_Controller{
function __construct(){
	...
	function index(){
		$data['main_view'] = 'admin/v_paket_kuisioner';
		$data['paket_kuisioner'] = $this->m_paket_kuisioner->paket_kuisioner()->result();
		$this->load->view('template/template_admin', $data);
	}
	
	function inputPaket(){
		$data['main_view'] = 'admin/v_tambah_paketkuisioner';
		$this->load->view('template/template_admin',$data);
	}
	...
	function updatePaket($id_paket){
		$data['main_view'] = 'admin/v_edit_paketkuisioner';
		$where = array('id_paket' => $id_paket);
