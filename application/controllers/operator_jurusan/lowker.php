...
function __construct(){
	...
	function tambahLowker(){
		...
		redirect('operator_jurusan/lowker');
	}
	...
	function hapusMahasiswa($nim){
		...
		redirect('operator_jurusan/alumni');
	}

	function updateMahasiswa($nim){
		$data['main_view'] = 'operator_jurusan/v_edit_alumi';
		$where = array('nim' => $nim);
	...
	function detail_lowker($id){
			$data['main_view'] = 'operator_jurusan/v_detail_pekerjaan';
