...
function __construct(){
	...
	function tambahOpen(){
		...
		redirect('operator_jurusan/opendonasi');
	}
	...
	function updateOpendonasi($id_opendonasi){
		$data['main_view'] = 'operator_jurusan/v_edit_open_donasi';
		$where = array('id_opendonasi' => $id_opendonasi);
