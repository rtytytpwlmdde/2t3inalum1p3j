        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                <form action="<?php echo base_url(). 'admin/lowker/editlowker'; ?>" method="POST">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input name="contact_person" type="text" class="form-control"value="<?php echo $u->contact_person ?>">
                      </div>
                    </div>
                  </div>
				  <div class="row">
