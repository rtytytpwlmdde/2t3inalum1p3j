...
<div class="row">
  ...
  <div  style="float:right" >
    ...
    <div class="d-flex flex-row-reverse bd-highlight">
     <a href="<?php echo base_url('admin/user/inputUser'); ?>" class="btn btn-info">Export Data Alumni</a>
    </div>
    </div>
    </div>
  </div>
		...
		<div class="card-body">
               <form action="<?php echo base_url(). 'admin/alumni/cek_alumni'; ?>" method="POST">
