<div class="container-fluid pt-2 pb-2">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="timeline-manage">
                <a href="<?php echo site_url('alumni/dashboard/open_donasi/'); ?>" class="btn btn-light btn-sm ">
        ...
        <div class="row">
            ...
            <div class="card  mb-2">
                ...
                <div class=""> 
                    ...
                    <span class="px-4 text-muted" title="alamat perusahaan"><i class="fas fa-map-marker-alt"></i>  <?php echo $u->alamat_perusahaan ?></span><br>
                    <span class="px-4 text-muted" title="Jumlah pegawai yang dibutuhkan"><i class="fas fa-user-tie"></i> <?php echo $u->pelamar_yang_dibutuhkan ?> Pegawai</span><br>
                    <span class="px-4 text-muted" title="kisaran gaji"><i class="fas fa-money-bill-wave"></i> Rp <?php echo $u->kisaran_gaji ?></span><br>
                    <span class="px-4 text-muted" title="email perusahaan"><i class="far fa-envelope"></i> <?php echo $u->email_perusahaan ?></span><br>
                    <span class="text-muted"><?php echo $u->lowongan_jabatan ?> </span> <br>
                    <span class="text-muted"> <?php echo $u->syarat_pekerjaan ?></span>
                </div>
