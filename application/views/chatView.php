	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("form#chatform").submit(function(){
				...
				$.post("<?php echo base_url(); ?>/chat/update",{
							message: $("#content").val(),
							name: $("#name").val(),
							action: "postmsg"
						}, function() {
		...
		function loadMsg() {
			$.get("<?php echo base_url(); ?>/chat/backend", function(xml) {
				$("#loading").remove();				
				addMessages(xml);
			});
...
<body>
	...
	<img src="<?php echo base_url(); ?>/images/blueloading.gif" alt="Loading data, please wait...">  
	</div><br />
