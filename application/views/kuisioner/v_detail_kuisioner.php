    ...
    <div class="col-md-2 mb-2">
      <ul class="list-group">
            ...
            <li class="list-group-item">
              <a class="" href="<?php echo base_url(). 'kuisioner/detailKuisioner/'.$id_kuisioner.'/'.$s->id_section; ?>">Section <?= $s->no_section;?></a>
              <a href="<?php echo base_url(). 'kuisioner/updateSection/'.$id_kuisioner.'/'.$s->id_section; ?>" title="atur kondisi section"> <i style="margin-left:12px" class="fas fa-cog"></i></a>
              <a href="<?php echo base_url(). 'kuisioner/hapusSection/'.$id_kuisioner.'/'.$s->id_section; ?>" title="Hapus section" class="text-danger"> <i class="fas fa-trash"></i></a>
              
              <label style="font-size:14px;"><?= $s->nama_section;?></label>
            </li>
            <?php 
            $nosection = 1+$s->no_section;} ?>
            <li class="list-group-item"><a class="" href="<?php echo base_url(). 'kuisioner/formTambahSection/'.$id_kuisioner.'/'.$nosection; ?>" 
              style="font-size:12px;"><i class="fas fa-plus-circle"></i>Tambah Section</a>
            </li>
      </ul>
    </div>
  </div>
