...
<div class="row">
    ...
    <div class="  mb-2">
        ...
        <!-- Card Body -->
        <div class="">
        <form action="<?php echo base_url(). 'kuisioner/tambahSection'; ?>" method="POST">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Nama Section</label>
                        <input name="nama_section" type="text" class="form-control" >
                    </div>
                    <div class="form-group">
                        <label>No Section</label>
                        <input name="no_section" type="text" class="form-control" value="<?= $no_section?>">
            ...
            <button type="submit" class="btn btn-fill btn-primary">Tambah Section</button>
        </form>
        </div>
    </div>
    </div>
