...
<div class="container-fluid pt-2 pb-2">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Ilazah </h1>
            <div class="timeline-manage">
            <div class="btn-group" role="group">
                  <a class="btn btn-sm btn-primary text-white"><i class="fas fa-file-excel"></i> Import</a>                                           
                  <a class="btn btn-sm btn-success text-white"><i class="fas fa-file-excel"></i> Excel</a>
                  <div class="btn-group">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <form  class="dropdown-item" action="<?php echo base_url('legalisir/recording/ijazah/' )?>" method="post">
                          <input type="text" name="validasi_ijazah" hidden value="4"><button class="btn btn-sm btn-danger text-white" type="submit">Tolak</button>
                      </form>
                      <form  class="dropdown-item" action="<?php echo base_url('legalisir/recording/ijazah/' )?>" method="post">
                          <input type="text" name="validasi_ijazah" hidden value="5"><button class="btn btn-sm btn-warning text-white" type="submit">Terkirim</button>
                      </form>
                      <form  class="dropdown-item" action="<?php echo base_url('legalisir/recording/ijazah/' )?>" method="post">
                          <input type="text" name="validasi_ijazah" hidden value="6"><button class="btn btn-sm btn-success text-white" type="submit">Setuju</button>
                      </form>
                  </div>
              </div>
              </div>
                    ...
                    <table class="table table-bordered">
                                ...
                                $date=date_create($u->tanggal_ijazah);
                                  ...
                                  <td><?= date_format($date,"d-m-Y") ; ?></td>
																	...
																	<td>
																	<a target="_blank" rel="noopener noreferrer" href="<?php echo base_url();?>pdf/<?php echo $u->nim ?>.pdf " class="btn btn-link btn-sm"><i class="far fa-file-pdf"></i>File</a>
																	</td>
																	<td><?php echo $u->validasi_ijazah ?></td>
																	<td><?php echo $u->catatan_ijazah ?></td>
																	
																	<td class="sorting_1" style="">
																		<a href="<?php echo site_url('leges/recording/validasiIjazah/'.$u->nomor_ijazah.'/setuju'); ?>" class="btn btn-sm btn-primary" title="Setuju Pengajuan Upload Ijazah">
																			setuju
																		</a>
																		<a data-toggle="modal"  data-target="#modalTolakIjazah" data-nomor_ijazah="<?= $u->nomor_ijazah; ?>" class="btn btn-sm btn-danger text-white" title="Tolak Pengajuan Upload Ijazah">
																			tolak
																		</a>
																	</td>
																</tr>
...
<div class="modal fade" id="modalTolakIjazah" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <form action="<?php echo base_url('leges/recording/tolakIjazah/'); ?>" method="post">
      <div class="modal-asd">
        <input type="hidden" class="id_transaksi_modal" name="nomor_ijazah" id="nomor_ijazah" value="">
      </div>
