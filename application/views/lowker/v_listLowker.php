    ...
    <div class="row">
            ...
            <div class="col-lg-9 mb-4">
                ...
                <div class="card shadow mb-2">
                    ...
                    <a href="<?php echo base_url("lowker/detailLowker/".$u->id_lowongan);?>"><h6 class="h4 m-0  text-primary"><?= $u->lowongan_jabatan?></h6></a>
            ...
            <div class="card shadow mb-3">
                <div class="card-body">
                    <a href="<?php echo base_url("lowker/myLowker");?>"><h6 class="m-0 font-weight-bold ">Lowongan Kerja Saya</h6></a>
