              ...
              <div class="col-lg-4">
                <div class="card card-small mb-4 pt-3">
                  <div class="card-header border-bottom text-center">
                    ...
                    <span class="text-muted d-block mb-2"><?php echo $this->session->userdata('Status') ?></span>
                  </div>
                    ...
                    <li class="list-group-item p-3">
                      <div class="row">
                        ...
                        <?php foreach($user as $u): ?>
                          <form action="<?php echo base_url(). 'operator_fakultas/profil/update_password'; ?>" method="POST">
                            <div class="form-row">
                            ...
                            <input hidden type="text" name="username" class="form-control" id="feFirstName" value="<?php echo $u->username ?>"> 
