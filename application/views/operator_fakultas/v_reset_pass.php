                ...
                <div class="card card-small mb-4">
                  ...
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-3">
                      <div class="row">
                        <div class="col">
                          <form action="<?php echo base_url(). 'admin/operator_fakultas/pass'; ?>" method="POST">
                ...
                <div class="card card-small mb-4 pt-3">
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item p-4">
                      ...
                      <span>1. Password pegawai yang diriset akan diambil berdasarkan 6 terakhir dari NIM.</span><br>
                      <span>2. Pastikan NIM pegawai tidak salah saat reset password.</span><br>
                    </li>
                  </ul>
                </div>
              </div>
