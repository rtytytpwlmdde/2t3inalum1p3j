...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/ajax/css/bootstrap.css'?>">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/ajax/css/jquery.dataTables.css'?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/ajax/css/dataTables.bootstrap4.css'?>">
</head>
<body>
<div class="container">
	<!-- Page Heading -->
...
<script type="text/javascript" src="<?php echo base_url().'assets/ajax/js/bootstrap.js'?>"></script>
<script type="text/javascript" src="<?php echo base_url().'assets/ajax/js/jquery.dataTables.js'?>"></script>
<script type="text/javascript" src="<?php echo base_url().'assets/ajax/js/dataTables.bootstrap4.js'?>"></script>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function show_product(){
		    $.ajax({
		        type  : 'ajax',
		        url   : '<?php echo site_url('kuisioner/dataPertanyaan')?>',
		        async : false,
		        dataType : 'json',
		        success : function(data){
		            ...
		            for(i=0; i<data.length; i++){
		                html += '<tr>'+
		                        ...
		                        '<td>'+data[i].nama_pertanyaan+'</td>'+
		                        '<td>'+data[i].jenis_pertanyaan+'</td>'+
		                        '<td style="text-align:right;">'+
                                    '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-product_code="'+data[i].id_pertanyaan+'" >Edit</a>'+' '+
                                    '<a href="javascript:void(0);" class="btn btn-danger btn-sm item_delete" data-product_code="'+data[i].id_pertanyaan+'">Delete</a>'+
                                '</td>'+
		                        '</tr>';
		            }
		            $('#show_data').html(html);
