        ...
        <div class="row newsfeed-size">
            <div class="col-md-12 message-right-side" id="page-content-wrapper">
                <nav id="navbar-main" class="navbar navbar-expand-lg napbar-atas sticky-top">
                    ...
                    <a class="navbar-brand mr-lg-5 ml-4 text-biru "  href="<?php echo base_url('alumni/dashboard'); ?>"><img src="<?php echo base_url(); ?>/assets/images/ub.png" class="mr-3" alt="Logo" width="35" height="35"> Sosial Media Alumni</a>
