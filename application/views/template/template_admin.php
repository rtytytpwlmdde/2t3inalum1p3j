...
<head>
  ...
  <title>Tracert Online FEB UB</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <img src="<?php echo base_url(); ?>/assets/images/ub.png" class="mr-3" alt="Logo" width="50" height="50">
        </div>
        <div class="sidebar-brand-text mx-3">Tracert Alumni</div>
      </a>
      ...
      <li class="nav-item dropdown">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('admin/alumni'); ?>">Mahasiswa</a>
            <a class="collapse-item" href="<?php echo base_url('admin/user'); ?>">Operator</a>
          </div>
        </div>
      </li>
	  <li class="nav-item dropdown">
      ...
      <li class="nav-item">
        ...
        <div id="lowonganPekerjaan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Users:</h6>
            <a class="collapse-item" href="<?php echo base_url('admin/lowker'); ?>">Lowongan Pekerjaan</a>
            <a class="collapse-item" href="<?php echo base_url('admin/lowker/riwayatpekerjaan'); ?>">Riwayat Lowker</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
	  ...
	  <li class="nav-item">
        ...
        <div id="masterdata" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('admin/groupchat'); ?>">Forum Komunikasi</a>
            <a class="collapse-item" href="<?php echo base_url('admin/jurusan'); ?>">Data Jurusan</a>
            <a class="collapse-item" href="<?php echo base_url('admin/prodi'); ?>">Data Program Studi</a>
            <a class="collapse-item" href="<?php echo base_url('admin/alumni/reset_password'); ?>">Reset Password</a>
            <a class="collapse-item" href="<?php echo base_url('admin/obrolan'); ?>">Reset Obrolan</a>
            <a class="collapse-item" href="<?php echo base_url('admin/background_foto'); ?>">Update Backgroud</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="<?php echo base_url('admin/profil/index/'.$this->session->userdata('username')); ?>">
