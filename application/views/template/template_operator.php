...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <?php if($this->session->userdata('status') == 'recording'){ ?>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('legalisir/legalisir/dashboard'); ?>">
            <i class="fas fa-circle-notch"></i>
          <span>Dashbaoard</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('legalisir/legalisir/transaksi'); ?>">
