                ...
                <div class="col ">
                    ...
                    <div class="class=" p-0 pb-3" style="overflow-x:auto;">
                        <div class="card">
                            ...
                            <a href="<?php echo site_url('validator/validasi/aksivalidasi_lowker/'.$u->id_lowongan.'/valid'); ?>" type="button" class="btn btn-primary" onclick="return valid();" title="Setuju Peminjaman">
                                <i class="fa fa-check">check</i>
                            </a>
                            <a href="<?php echo site_url('validator/validasi/aksivalidasi_lowker/'.$u->id_lowongan.'/tolak'); ?>"  type="button" class="btn btn-danger" onclick="return tolak();" title="Tolak Peminjaman">
