...
<head>
    ...
    <div class="d-flex flex-row-reverse bd-highlight">
     <a hidden href="<?php echo base_url('admin/opendonasi/inputOpen'); ?>" class="btn btn-info">Tambah Data Open Donasi</a>
    </div>
  </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mx-auto d-block">
									 ...
									 <h5 class="text-sm-left mt-2 mb-1"><?php echo $u->total_anggaran ?></h5>
									 <h5 class="text-sm-left mt-2 mb-1"><?php echo $u->No_rekening ?></h5>
                                    <div class="location text-sm-left"><i class="fa fa-map-marker"></i> <?php echo $u->lokasi ?></div>
                                    <div class="location text-sm-left"><i class="fa fa-map-marker"></i> <?php echo $u->contact_person ?></div>
                                </div>
                                <hr>
                            </div>
                        </div>
