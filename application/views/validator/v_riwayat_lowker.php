...
<head>
    ...
    <link rel="shortcut icon" href="https://i.imgur.com/QRAUqs9.png">
	 <div class="col-sm-6">
    <h1 class="h3 mb-2 text-gray-800">Master Lowongan Pekerjaan</h1>
  </div>
  <div class="col-sm-12">
    <div class="d-flex flex-row-reverse bd-highlight">
     <a href="<?php echo base_url('validator/lowker/inputLowker'); ?>" class="btn btn-info">Tambah Data Lowker</a>
    </div>
  </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
								...
								<div class="td-actions text-left">
                                    <a href="<?php echo site_url('validator/lowker/updateLowongan/'.$u->id_lowongan); ?>"type="button" rel="tooltip" class="btn btn-success btn-sm btn-round btn-icon">
                                    <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="<?php echo site_url('validator/lowker/hapusLowongan/'.$u->id_lowongan); ?>" type="button"  rel="tooltip" class="btn btn-danger btn-sm btn-round btn-icon" onclick="return deletechecked();" title="Hapus">
